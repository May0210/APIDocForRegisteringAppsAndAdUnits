...
若您使用人民币结算，则使用 https://pa-batman.zplayads.com

若您使用美元结算，则使用 https://pa-batman-en.zplayads.com
...
### 2.1 描述
开发者创建应用及广告位，每天最多请求1000次

### 2.2 接口信息

url | method | 说明
---|---|--
/api/replace_info | POST | 创建应用及广告位
...
developer_account_id | string |  是 | Account ID，请到ZPLAY Ads开发者自助系统[个人信息](https://sellers.zplayads.com/#/personal/personalInfo/)页面下方获取您的Account ID
developer_api_key | string |  是 | API Key，请到ZPLAY Ads开发者自助系统[个人信息](https://sellers.zplayads.com/#/personal/personalInfo/)页面下方获取您的API Key
os  | string |  是 | 应用操作系统，值为iOS，Android 
source_app_id | string |  否 | 若您有自己的应用唯一标识规则，则填写该ID，若没有，则置空
app_name | string |  是 | 应用名称，100字符以内，应用名称应在每个渠道下应唯一；
package_name | string |  是 | 应用包名，100字符以内，应用包名应在每个渠道下应唯一；
...
字段|数据类型|是否必填|说明
---|---|---|---
source_unit_id | string |  否 | 若您有自己的广告位唯一标识规则，则填写该ID；若没有，则置空；source_app_id与source_unit_id必须同时有值或同时为空；
unit_name | string |  是 | 广告位名称，100字符以内；广告位名称应在每个应用下唯一；
...
render_style | string |  否 | 原生广告的渲染样式。当广告形式为原生且渲染方式为托管渲染时，此字段必填，值为DF0641C3-B89B-AE2E-52E3-33E89ADB6BC1，目前仅支持一种渲染样式
...
```json
{
    "signature": "5d796971c0d3f54b15d5e2bdb5a967f4c353b808",
    "timestamp": 1545977627,
    "nonce": 1,
    "developer_account_id": "8CBD07ED-F471-5C3C-985E-9064C3D26EFC",
    "developer_api_key": "54A84C92-6CDA-CAF9-1E7F-8563BCFCDD65",
    "os": "iOS",
    "source_app_id": "",
    "app_name": "PopStar-Star Blast Puzzle Game",
    "package_name": "com.zplay.popstar",
    "category": "AED099F1-2B7E-9A52-9F2E-D4F7CFE500AA",
    "download_url": "https://itunes.apple.com/cn/app/id834878585?mt=8",
    "app_store": 50,
    "industry_filter": "AED099F1-2B7E-9A52-9F2E-D4F7CFE500AA,36FBA1A1-C5E7-D9F6-9170-9BA0DA13CBF9",
    "data": [
        {
            "source_unit_id": "",
            "unit_name": "PopstarInterstitial",
            "ad_type": 1,
            "can_be_skipped": "",
            "render_method": "",
            "render_style": "",
            "remark": "PopstarAdunit"
        },
        {
            "source_unit_id": "",
            "unit_name": "PopstarNative",
            "ad_type": 3,
            "can_be_skipped": "",
            "render_method": 1,
        ...
        {
            "source_unit_id": "",
            "unit_name": "PopstarRewardedVideo",
            "ad_type": 4,
            "can_be_skipped": -1,
            "render_method": "",
            "render_style": "",
...
{
    "error": "",
    "app_id": "4ECF6BDC-2D9B-3E0C-D86C-FBEEC079B361",
    "app_status": 1,
    "ad_units": [
        {
            "ad_unit_id": "FB7652F7-791F-B8E3-1145-9E62CA49D972",
            "ad_unit_status": 1
        },
        {
            "ad_unit_id": "4F91FE4C-3C3F-CBFC-5584-2D2594932108",
            "ad_unit_status": 1
        },
        {
            "ad_unit_id": "7087BE83-F031-7731-D33E-138394E94E1E",
            "ad_unit_status": 1
        }
    ]
}
